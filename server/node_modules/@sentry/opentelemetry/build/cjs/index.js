 ...
 */
function generateSpanContextForPropagationContext$1(propagationContext) {
  // We store the DSC as OTEL trace state on the span context
...
function shouldPropagateTraceForUrl(
  ...
  const cachedDecision = _optionalChain$6([decisionMap, 'optionalAccess', _5 => _5.get, 'call', _6 => _6(url)]);
  ...
  _optionalChain$6([decisionMap, 'optionalAccess', _7 => _7.set, 'call', _8 => _8(url, decision)]);
...
function getInjectionData(context)

 {
  ...
  const scope = _optionalChain$6([getScopesFromContext, 'call', _12 => _12(context), 'optionalAccess', _13 => _13.scope]) || core.getCurrentScope();
...
function getCurrentURL(span) {
  ...
  // eslint-disable-next-line deprecation/deprecation
  const urlAttribute = _optionalChain$6([spanData, 'optionalAccess', _14 => _14[semanticConventions.SEMATTRS_HTTP_URL]]) || _optionalChain$6([spanData, 'optionalAccess', _15 => _15[semanticConventions.ATTR_URL_FULL]]);
  if (urlAttribute) {
    return urlAttribute;
  }
...
exports.generateSpanContextForPropagationContext = generateSpanContextForPropagationContext$1;
